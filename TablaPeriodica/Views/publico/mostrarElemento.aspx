                ...
                <asp:Table ID="TableElement" runat="server">
                    <asp:TableRow runat="server" ID="ElementoTabla">
                        ...
                        <asp:TableCell ID="TableCell2" runat="server">
                            <asp:TextBox ID="txtSimbolo" runat="server"></asp:TextBox></asp:TableCell>
                    </asp:TableRow>
