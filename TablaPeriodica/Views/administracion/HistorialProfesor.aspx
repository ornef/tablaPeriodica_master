...
<asp:Content ID="Content4" ContentPlaceHolderID="cuerpo_va_aqui" runat="server">
    ...
    <br />
    <asp:GridView ID="GridView1" runat="server" CssClass="TableElement" Width="90%" AutoGenerateColumns="false" emptydatatext="No hay datos para mostrar" BackColor="WhiteSmoke" OnRowEditing="GridView1_RowEditing" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowUpdating="GridView1_RowUpdating">
