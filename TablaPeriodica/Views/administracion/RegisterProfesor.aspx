<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterProfesor.aspx.cs" Inherits="TablaPeriodica.Views.administracion.RegisterProfesor" %>
...
<body>
    ...
    <header>
        ...
        <div id="titulo">2 Registrar Profesor 3</div>
        <div id="clear"></div>
    </header>
    <div class="container">
            ...
            <div class="modal-body" style="overflow-y: visible;">
                <div class="well">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#login" data-toggle="tab">Registrar</a></li>
                    </ul>
